...
class BINARYNINJAUIAPI ScriptingConsoleOutput : public QTextEdit
{
 ...
 public:
	...
	bool IsNavigable(const QString& str, const std::pair<int, int>& offsetLen, uint64_t& value,
...
class BINARYNINJAUIAPI ScriptingConsole :
    public QWidget,
    ...
    BinaryNinja::ScriptingOutputListener
{
 ...
 public:
	ScriptingConsole(QWidget* parent, const QString& providerName, const QString& instanceName,
