...
fn parse_function_entry<R: Reader<Offset = usize>>(
    ...
    let mut raw_name = get_raw_name(&dwarf, &unit, &entry);
...
impl CustomDebugInfoParser for DWARFParser {
    ...
    fn parse_info(&self, debug_info: &mut DebugInfo, view: &BinaryView) {
        ...
        // for name, t in dwarf_debug_info.types() {
        //     debug_info.add_type(name, t.as_ref());
        // }
        ...
        // TODO : Prefer the match return syntax for these variable assignments
